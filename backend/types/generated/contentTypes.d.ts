...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    etiquetas: Schema.Attribute.Relation<'oneToMany', 'api::etiqueta.etiqueta'>;
    introduccion: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCitaCita extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Solicitudes de agendamiento de citas';
    displayName: 'Cita';
    pluralName: 'citas';
    singularName: 'cita';
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cita.cita'> &
      Schema.Attribute.Private;
    modalidad: Schema.Attribute.Enumeration<['virtual', 'presencial']> &
      Schema.Attribute.Required;
...
export interface PluginStrapiMercadopagoCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::strapi-mercadopago.category'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface PluginStrapiMercadopagoOrder
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    collector_id: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer: Schema.Attribute.Component<'mercadopago.customer', false> &
      Schema.Attribute.Required;
    fulfillment: Schema.Attribute.Component<'mercadopago.fulfillment', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    total_discount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginStrapiMercadopagoProduct
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    information: Schema.Attribute.Component<'mercadopago.information', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    middle_description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    price: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    promotion: Schema.Attribute.Component<'mercadopago.promotion', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'plugin::strapi-mercadopago.category': PluginStrapiMercadopagoCategory;
      'plugin::strapi-mercadopago.order': PluginStrapiMercadopagoOrder;
      'plugin::strapi-mercadopago.product': PluginStrapiMercadopagoProduct;
