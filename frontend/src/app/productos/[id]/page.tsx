...
const productos = [
  {
    ...
    howToUse:
      'Agrega 2-3 gotas en un difusor, aplica diluido en puntos de pulso o agrega a tu baño nocturno.',
  ...
  },
  {
    ...
    howToUse:
      'Mantén cerca durante la meditación, lleva contigo o coloca en tu espacio personal.',
  ...
  },
  {
    ...
    howToUse:
      'Reserva tu sesión y prepárate para una experiencia transformadora.',
...
export default async function ProductOverview({
  ...
  if (!product) {
    return (
      <div className="bg-principal flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <Link
            href="/productos"
            className="from-secundario to-terciario hover:from-terciario hover:to-secundario rounded-full bg-gradient-to-br px-6 py-3 text-white transition-all hover:bg-gradient-to-br"
          >
            Volver a productos
          </Link>
        </div>
