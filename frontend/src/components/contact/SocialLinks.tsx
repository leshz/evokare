import type { RedSocial, RedSocialTipo } from '@/services/contacto/types';

interface SocialLinksProps {
  redes: RedSocial[];
}

const SocialIcon = ({ tipo }: { tipo: RedSocialTipo }) => {
  switch (tipo) {
    case 'twitter':
      return (
...
export const SocialLinks = ({ redes }: SocialLinksProps) => {
