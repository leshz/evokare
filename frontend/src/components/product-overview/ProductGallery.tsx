        ...
        {images.length > 1 && (
          <>
            <button
              ...
              className="bg-opacity-80 hover:bg-opacity-100 absolute top-1/2 left-4 -translate-y-1/2 rounded-full bg-white p-2 opacity-0 shadow-lg transition-all group-hover:opacity-100"
            >
              <svg
            ...
            <button
              onClick={handleNext}
              className="bg-opacity-80 hover:bg-opacity-100 absolute top-1/2 right-4 -translate-y-1/2 rounded-full bg-white p-2 opacity-0 shadow-lg transition-all group-hover:opacity-100"
            >
              <svg
                className="h-6 w-6 text-gray-600"
                fill="none"
