...
export const BlocksRendererCustom: React.FC<BlocksRendererCustomProps> = ({
  ...
  const getClassString = (
    ...
    const classes = [baseColor, colorClass, customClass]
      .filter(Boolean)
      .join(' ');
    return classes;
  };
    ...
    <BlocksRenderer
      ...
      blocks={{
        ...
        heading: ({ children, level }) => {
          const headingClass = classNames.heading?.[
            `h${level}` as keyof typeof classNames.heading
          ] as string | undefined;
        ...
        quote: ({ children }) => (
          <blockquote
            className={getClassString(colors.quote, classNames.quote)}
          >
            {children}
          </blockquote>
        ),
      ...
      modifiers={{
        ...
        italic: ({ children }) => (
          <em
            className={getClassString(
              modifierColors.italic,
              modifierClassNames.italic
            )}
          >
            {children}
          </em>
        ...
        underline: ({ children }) => (
          <u
            className={getClassString(
              modifierColors.underline,
              modifierClassNames.underline
            )}
          >
            {children}
          </u>
        ...
        strikethrough: ({ children }) => (
          <s
            className={getClassString(
              modifierColors.strikethrough,
              modifierClassNames.strikethrough
            )}
          >
            {children}
          </s>
